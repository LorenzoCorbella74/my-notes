...
var vertices = [];          //Targets light rays point to

var barriers = [];          //Objects that cast shadows

var lights = [];            //Light sources

var corners = [];           //Limits of the canvas

var TWO_PI = 2 * Math.PI;


var maxlimits = [];         //Ray intersection with canvas limits

var minlimits = [];         //Closest collision points for all rays

var epsilon = 0.00001;      //Small value between rays cast around vertices

var p_;                     //Collision point 
var mouse_pos_x = 2;
var mouse_pos_y = 2;


var drag = false;           //Is mouse being pressed down

var active_light = -1;      //Index of light being dragged around
...
var clear_area = {x: (canvas.width/2-100)-2*delta, y: (canvas.height/2-40)-2*delta, width: c_w+2*delta, height: c_h+2*delta};
...
function draw() {
  ...
  scale = canvas.width/canvas.scrollWidth;
